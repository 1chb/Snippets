...
-- >>> [(round x, calc $ x/100) | x <- [325, 780, 745, 710, 685, 660, 635, 550, 510, 480, 430, 435, 425, 405, 375, 345, 320, 295, 275, 235]]
-- >>> let n = 40 -- [(x = oil depth (mm), y = oil volume (l))]
-- >>> [(round $ x*100, calc x) | k <- [0..n], let x = d*k/n]
-- (1000,3820)
-- [(325,845),(780,2511),(745,2397),(710,2278),(685,2190),(660,2101),(635,2009),(550,1691),(510,1538),(480,1424),(430,1233),(435,1252),(425,1215),(405,1139),(375,1028),(345,918),(320,828),(295,739),(275,671),(235,537)]
